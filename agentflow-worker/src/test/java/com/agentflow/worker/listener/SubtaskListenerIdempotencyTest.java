...
class SubtaskListenerIdempotencyTest {
    ...
    private final SubtaskListener listener = new SubtaskListener(processor, template, guard);
    ...
    void skipsProcessingWhenAlreadyProcessed() throws Exception {
        ...
        listener.onMessage(new SubtaskMessage(1L, 10L, "u", "ECHO_BATCH", 0, "{\"text\":\"a\"}"));
    ...
    void processesAndMarksWhenFirstTime() throws Exception {
        ...
        listener.onMessage(new SubtaskMessage(1L, 10L, "u", "ECHO_BATCH", 0, "{\"text\":\"hi\"}"));
